...
export function isOwner(whatsappNumber) {
  ...
  const envOwner = process.env.OWNER_NUMBER !== undefined && process.env.OWNER_NUMBER !== null && process.env.OWNER_NUMBER !== '' ? normalizePhone(process.env.OWNER_NUMBER) : null;
  const envAdmin = process.env.ADMIN_NUMBER !== undefined && process.env.ADMIN_NUMBER !== null && process.env.ADMIN_NUMBER !== '' ? normalizePhone(process.env.ADMIN_NUMBER) : null;
  
  return (envOwner && phone === envOwner) || (envAdmin && phone === envAdmin) || false;
}
