...
client.on('message', async (msg) => {
  ...
  try {
    if (isAdmin && ['grant', 'quitar', 'stats', 'ban', 'registrar', 'add', 'remove', 'admin', 'censo', 'fichas', 'pendientes', 'pendiente', 'purga', 'groupid', 'grupos', 'grupoactual', 'staff', 'bitacora'].includes(command)) {
