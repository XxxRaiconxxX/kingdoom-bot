    ...
    if (isSenderOwner) {
      return heraldCard('Menu del soberano', [
        ...
        heraldList([
          ...
          heraldCommand('!verificarnumero <celular> <id>', 'Vincula manualmente un celular.'),
          heraldCommand('!desvincular <objetivo>', 'Desvincula celular de WhatsApp.'),
        ...
        heraldList([
          ...
          heraldCommand('!coliseo [minutos]', 'Inicia torneo PvP de razas en arena y abre apuestas.'),
          heraldCommand('!data <titulo> [txt/url]', 'Guarda documento en el grimorio.'),
