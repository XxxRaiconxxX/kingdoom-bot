    ...
    .on(
      ...
      async (payload) => {
        try {
          ...
          const chatId = newAuction.whatsapp_chat_id || (process.env.TARGET_GROUP_ID !== undefined ? process.env.TARGET_GROUP_ID : '');
    ...
    .on(
      ...
      async (payload) => {
        try {
          ...
          const chatId = auction.whatsapp_chat_id || (process.env.TARGET_GROUP_ID !== undefined ? process.env.TARGET_GROUP_ID : '');
          const msg = `╔════════════════════════════╗\n` +
